<template>
  <div id="header">
    ...
    <div id="cart">
      <img src="../assets/shopping-cart-solid.png" alt="" />
    </div>
    <div id="user-image">
      <img src="../assets/carbon_user.png" alt="" id="img-user" />
